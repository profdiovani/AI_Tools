...
As ferramentas estão organizadas por **categoria**, contendo **link direto**, **descrição prática de valor** e **status de acesso**, facilitando a avaliação e adoção em contextos corporativos.

**Legenda de Status:**
- 🟢 **Gratuito** – Acesso sem custos
- 🟡 **Freemium** – Versão gratuita com limitações; versão paga oferece mais funcionalidades
- 🔴 **Pago** – Requer assinatura
- 🔵 **Open Source** – Código aberto, pode ser auto-hospedado
...
* [Buscadores com IA](#buscadores-com-ia)
...
* [Desenvolvimento e Código](#desenvolvimento-e-código)
* [Modelos e Frameworks](#modelos-e-frameworks)
* [LLMs Locais e Execução Privada](#llms-locais-e-execução-privada)
...
* **<a href="https://grok.com" target="_blank">Grok</a>** 🟡  
  Assistente de IA desenvolvido pela xAI com acesso em tempo real a informações do X (Twitter), ideal para análise de tendências, notícias e conversas em redes sociais.
...
* **<a href="https://www.blogseo.io" target="_blank">BlogSEO</a>** 🟡  
  Plataforma de SEO com IA focada em crescimento de tráfego orgânico, com ênfase em conteúdo e uso de dados estruturados (JSON-LD/Schema.org) para visibilidade em mecanismos de busca e respostas gerativas.
...
* **<a href="https://www.midjourney.com" target="_blank">Midjourney</a>** 🔴  
  Geração de imagens artísticas de alta qualidade a partir de prompts textuais. Acesso via Discord, assinatura obrigatória.
...
* **<a href="https://openai.com/dall-e" target="_blank">DALL·E 3 – OpenAI</a>** 🟡  
  Modelo de geração de imagens integrado ao ChatGPT, com alta fidelidade a prompts complexos.

* **<a href="https://stability.ai" target="_blank">Stable Diffusion</a>** 🟡  
  Modelo open source para geração de imagens localmente com controle total e privacidade.

* **<a href="https://designer.microsoft.com" target="_blank">Microsoft Designer</a>** 🟡  
  Ferramenta de design gráfico assistido por IA para materiais de marketing e redes sociais.

* **<a href="https://clipdrop.co" target="_blank">ClipDrop</a>** 🟡  
  Ferramentas de edição e geração de imagens com IA (remoção de objetos, upscaling, transformações).
...
* **<a href="https://www.synthesia.io" target="_blank">Synthesia</a>** 🔴  
  Criação de vídeos a partir de texto com avatares de IA para treinamentos e comunicação corporativa.

* **<a href="https://www.heygen.com" target="_blank">HeyGen</a>** 🟡  
  Plataforma de vídeos com avatares realistas e sincronização labial avançada.

* **<a href="https://www.d-id.com" target="_blank">D-ID</a>** 🟡  
  Criação de apresentadores virtuais com controle de expressões faciais.

* **<a href="https://vidyo.ai" target="_blank">Vidyo.ai</a>** 🟡  
  Geração automática de vídeos curtos para redes sociais a partir de conteúdos longos.

* **<a href="https://elevenlabs.io" target="_blank">ElevenLabs</a>** 🟡  
  Síntese de voz realista para podcasts, audiolivros e conteúdos acessíveis.

* **<a href="https://otter.ai" target="_blank">Otter.ai</a>** 🟡  
  Transcrição automática de reuniões com identificação de falantes e resumos.

* **<a href="https://meetgeek.ai" target="_blank">MeetGeek</a>** 🟡  
  Análise avançada de reuniões com extração de insights e itens de ação.
...
* **<a href="https://poe.com" target="_blank">Poe</a>** 🟡  
  Interface unificada para múltiplos modelos de IA e criação de bots especializados.

* **<a href="https://www.chatpdf.com" target="_blank">ChatPDF</a>** 🟡  
  Análise conversacional de documentos PDF para contratos e relatórios extensos.
...
* **<a href="https://brightdata.com" target="_blank">Bright Data</a>** 🔴  
  Coleta e monitoramento de dados públicos em larga escala para inteligência competitiva.

* **<a href="https://www.akkio.com" target="_blank">Akkio</a>** 🟡  
  Plataforma de análise preditiva sem necessidade de data scientists.
...
* **<a href="https://www.juridico.ai" target="_blank">JurídicoAI</a>** 🔴  
  Análise automatizada de contratos com identificação de riscos.
...
* **<a href="https://www.artbreeder.com" target="_blank">Artbreeder</a>** 🟡  
  Criação e combinação de imagens artísticas para prototipagem visual.
...
* **<a href="https://mapify.ai" target="_blank">Mapify</a>** 🟡  
  Visualização geográfica e mapas interativos para análise espacial.

* **<a href="https://www.mixo.io" target="_blank">Mixo.io</a>** 🟡  
  Criação automatizada de sites e landing pages para validação rápida.
...
* **<a href="https://www.grammarly.com" target="_blank">Grammarly</a>** 🟡  
  Correção gramatical e melhoria de redação com sugestões de tom.
...
* **<a href="https://github.com/features/copilot" target="_blank">GitHub Copilot</a>** 🔴  
  Assistente de programação em VS Code e IDEs com sugestões contextualizadas.

* **<a href="https://github.com/github/copilot-sdk" target="_blank">GitHub Copilot SDK</a>** 🟢  
  SDK multi-plataforma (Node.js, Python, Go, .NET) para integrar Copilot CLI em aplicações via JSON-RPC.

* **<a href="https://kilo.ai/pricing" target="_blank">Kilo AI</a>** 🟡  
  Plataforma de desenvolvimento acelerado com IA para codificação autônoma e automação de fluxos.

* **<a href="https://openai.com/index/openai-codex/" target="_blank">OpenAI Codex</a>** 🟡  
  Modelo especializado em geração de código a partir de linguagem natural, base do GitHub Copilot.

* **<a href="https://claude.com/product/claude-code" target="_blank">Claude Code</a>** 🟡  
  Ferramenta de codificação avançada do Anthropic com raciocínio complexo.

* **<a href="https://manus.im/" target="_blank">Manus</a>** 🟡  
  Plataforma de IA agente autônomo para desenvolvimento e automação avançada. Executa tarefas complexas multi-etapas de forma independente.

* **<a href="https://cursor.com" target="_blank">Cursor</a>** 🔴  
  IDE baseado em VS Code com IA integrada, autocompletar preciso e compreensão avançada de codebase.

* **<a href="https://continue.dev" target="_blank">Continue.dev</a>** 🟢  
  Extensão VS Code com suporte a modelos locais e APIs para IA privada.

* **<a href="https://cline.bot" target="_blank">Cline</a>** 🟢  
  Extensão VS Code para tarefas multi-passos com IA e automação de fluxos.

* **<a href="https://lovable.dev" target="_blank">Lovable</a>** 🟡  
  Plataforma para criar aplicações web e sites conversando com IA, sem codificação manual.
...
* **<a href="https://huggingface.co" target="_blank">Hugging Face</a>** 🟢  
  Hub com 100.000+ modelos de IA, datasets e Spaces para ML open source.
...
* **<a href="https://pytorch.org" target="_blank">PyTorch</a>** 🟢  
  Framework de ML desenvolvido pelo Meta, preferido em pesquisa.
...
* **<a href="https://ollama.com" target="_blank">Ollama</a>** 🟢  
  Executa LLMs localmente (Llama 3, DeepSeek, Mistral) com interface simplificada.

* **<a href="https://gpt4all.io" target="_blank">GPT4All</a>** 🟢  
  Interface para rodar modelos localmente sem GPU, IA offline e privada.

* **<a href="https://docs.openwebui.com" target="_blank">Open WebUI</a>** 🟢  
  Interface web open-source para LLMs locais com Ollama ou APIs.

* **<a href="https://lmstudio.ai" target="_blank">LM Studio</a>** 🟢  
  GUI intuitivo para execução local com inferência rápida.
...
* **<a href="https://colab.google" target="_blank">Google Colab</a>** 🟢  
  Notebooks Jupyter com GPU/TPU gratuita para prototipagem de IA.

* **<a href="https://cloud.google.com/vertex-ai" target="_blank">Vertex AI</a>** 🟡  
  Plataforma ML gerenciada do Google com ferramentas enterprise.

* **<a href="https://kaggle.com" target="_blank">Kaggle</a>** 🟢  
  Comunidade de dados com notebooks, competições e datasets públicos.
...
* **<a href="https://botpress.com" target="_blank">Botpress</a>** 🟡  
  Framework para criar agentes de IA e chatbots com orquestração visual.

* **<a href="https://rasa.com" target="_blank">Rasa</a>** 🟢  
  Plataforma open-source para chatbots com NLP avançado.

* **<a href="https://crewai.com" target="_blank">CrewAI</a>** 🟢  
  Framework para agentes colaborativos que resolvem tarefas complexas.

* **<a href="https://microsoft.github.io/autogen" target="_blank">AutoGen</a>** 🟢  
  Framework Microsoft para orquestração multi-agente.

* **<a href="https://www.emergentagent.com/landing/" target="_blank">Emergent Agent</a>** 🟡  
  Plataforma para agentes autônomos com planejamento avançado.

* **<a href="https://www.langchain.com/langsmith/agent-builder" target="_blank">LangSmith Agent Builder</a>** 🟡  
  Criação de agentes via linguagem natural com templates e observabilidade.

---

## Datasets e Machine Learning

* **<a href="https://huggingface.co" target="_blank">Hugging Face</a>** 🟢 – Modelos, datasets e pipelines de ML.
* **<a href="https://www.kaggle.com" target="_blank">Kaggle</a>** 🟢 – Competições e datasets públicos.
* **<a href="https://archive.ics.uci.edu" target="_blank">UCI ML Repository</a>** 🟢 – Repositório acadêmico clássico.
* **<a href="https://datasetsearch.research.google.com" target="_blank">Google Dataset Search</a>** 🟢 – Busca de datasets públicos.

---

## 3D

* **<a href="https://hyper3d.ai" target="_blank">Rodin (Hyper3D.AI)</a>** 🟡 – Geração de modelos 3D a partir de imagens/texto.
...
- Enviar <a href="https://github.com/profdiovani/AI_Tools/pulls" target="_blank">pull requests</a>
